                ...
                <View style={styles.mainscreen}  >
                    ...
                    <View style={styles.otp}>
                        ...
                        <TextInput ref={'otp1ref'}
                            ...
                            //     if (nativeEvent.key === 'Backspace' && this.state.otp3 == '' && this.state.otp2 != '') {
                            //         this.refs.otp2ref.focus()
                            //         this.setState({ otp2: '' })
                            //     }
                            // }}
                        ...
                        <TextInput ref={'otp2ref'}
                            ...
                            onKeyPress = {({nativeEvent}) => {
                                if (nativeEvent.key === 'Backspace' && this.state.otp2 == '' && this.state.otp1 != '') {
                                    this.refs.otp1ref.focus()
                                    this.setState({ otp1: '' })
                                }
                            }}
                        ...
                        <TextInput ref={'otp4ref'}
                            ...
                            onKeyPress = {({nativeEvent}) => {
                                if (nativeEvent.key === 'Backspace' && this.state.otp4 == '' && this.state.otp3 != '') {
                                    this.refs.otp3ref.focus()
                                    this.setState({ otp3: '' })
                                }
                            }}
